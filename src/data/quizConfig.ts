...
export const quizQuestions: QuizQuestion[] = [
  // PERGUNTAS INICIAIS DE PERFIL
  {
    ...
    type: 'single',
    options: [
      { id: 'age_18_25', text: '18-25 anos 🌸', value: 'young', points: 8 },
      { id: 'age_26_35', text: '26-35 anos 💪', value: 'adult', points: 6 },
      { id: 'age_36_45', text: '36-45 anos 🌟', value: 'mature', points: 4 },
      { id: 'age_46_plus', text: '46+ anos 👑', value: 'experienced', points: 2 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'body_slim', text: 'Magra, mas com algumas áreas que me incomodam 🤏', value: 'slim_areas', points: 8 },
      { id: 'body_curvy', text: 'Curvilínea, mas quero definir melhor 💃', value: 'curvy', points: 6 },
      { id: 'body_overweight', text: 'Acima do peso que gostaria de estar ⚖️', value: 'overweight', points: 3 },
      { id: 'body_obese', text: 'Muito acima do meu peso ideal 😔', value: 'obese', points: 1 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'dream_toned', text: 'Tonificada e definida, sem exageros 💪', value: 'toned', points: 6 },
      { id: 'dream_slim', text: 'Magra e elegante, como uma modelo 👗', value: 'slim', points: 4 },
      { id: 'dream_curvy', text: 'Curvas no lugar certo, cintura fina 🍑', value: 'curvy_fit', points: 4 },
      { id: 'dream_healthy', text: 'Saudável e confiante, sem obsessões 🌟', value: 'healthy', points: 2 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q2a', text: 'Eu sempre começo empolgada e desisto em semanas 💪…😞', value: 'motivation', points: 4 },
      { id: 'q2b', text: 'Eu me sinto culpada porque um deslize destrói tudo 😬…🗑️', value: 'guilt', points: 2 },
      { id: 'q2c', text: 'Eu faço tudo certo mas nada muda e me sinto estagnada ✅…😐', value: 'stagnation', points: 1 },
      { id: 'q2d', text: 'Eu vivo um looping que se repete em silêncio, sem aviso 🌀', value: 'loop', points: 2 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q3a', text: 'Eu venho tentando há meses 🕒', value: 'months', points: 6 },
      { id: 'q3b', text: 'Eu já perdi anos da minha vida com isso 🕔', value: 'years', points: 4 },
      { id: 'q3c', text: 'Eu luto contra isso há mais de uma década 🕖', value: 'decade', points: 2 },
  ...
  // ETAPA 2/6: As Mentiras que o Mercado Te Fez Acreditar 🤥
  {
    ...
    options: [
      ...
      { id: 'q4b', text: 'Eu perdi peso no início, mas depois travei completamente 🚫', value: 'plateau', points: 2 },
      { id: 'q4c', text: 'Eu simplesmente não consegui manter por muito tempo 😓', value: 'unsustainable', points: 3 },
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q5a', text: 'Eu não tinha tempo nem energia pra manter ⏰😴', value: 'time_energy', points: 4 },
      { id: 'q5b', text: 'Eu acabei me machucando ou sentindo dores 🤕🩹', value: 'injuries', points: 5 },
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q6a', text: 'Eu acho que meu corpo não responde como o dos outros 😔', value: 'different', points: 2 },
      { id: 'q6b', text: 'Eu sinto que deve ter algo que ainda não descobri 🤔', value: 'missing', points: 3 },
  ...
  // ETAPA 3/6: Os Sinais Que Você Aprendeu a Ignorar 🚨
  {
    ...
    type: 'single',
    options: [
      { id: 'q7a', text: 'Eu sou o Beliscador Infinito – preciso mastigar o dia inteiro 😋', value: 'constant', points: 2 },
      ...
      { id: 'q7d', text: 'Eu sou um pouco de tudo, em horários diferentes 😵‍💫', value: 'mixed', points: 2 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q8c', text: 'Eu continuo igual — nada muda no meu corpo 😐', value: 'same', points: 6 },
      { id: 'q8d', text: 'Eu nunca reparei, mas talvez esteja me sabotando 😶', value: 'unaware', points: 4 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q9b', text: 'Eu acho que sinto um pouco de diferença 😐', value: 'maybe', points: 3 },
      { id: 'q9c', text: 'Eu sinto tudo igual 🤷', value: 'same', points: 8 },
      { id: 'q9d', text: 'Eu nunca percebi isso antes 👀', value: 'never_noticed', points: 5 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q10b', text: 'Eu nunca pensei assim, mas isso descreve minha vida 🤔', value: 'describes', points: 2 },
      { id: 'q10c', text: 'Não, eu acredito que é só falta de disciplina minha 😴', value: 'discipline', points: 8 },
      { id: 'q10d', text: 'Eu sinto às vezes, mas não sei de onde vem ❓', value: 'sometimes', points: 4 },
    ],
  ...
  // ETAPA 4/6: Revelando o Inimigo Interno 🧬
  {
    ...
    type: 'single',
    options: [
      { id: 'q11a', text: 'Sim, isso explicaria muita coisa que eu vivo 😮', value: 'explains', points: 2 },
      { id: 'q11b', text: 'Faz sentido, mas eu quero ver como usar isso 🧠', value: 'how_to_use', points: 4 },
      { id: 'q11c', text: 'Me parece simplista, mas eu estou curiosa 👀', value: 'curious', points: 6 },
      { id: 'q11d', text: 'Eu não sei se acredito nisso 🤨', value: 'skeptical', points: 8 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q12a', text: 'Não, eu estou ouvindo pela primeira vez 😶', value: 'first_time', points: 6 },
      { id: 'q12b', text: 'Eu já ouvi, mas não sabia o que era 🤔', value: 'heard_not_knew', points: 4 },
      { id: 'q12c', text: 'Sim, mas eu achava que só funcionava com remédio 💉', value: 'medicine_only', points: 2 },
      { id: 'q12d', text: 'Eu só ouvi por alto 👂', value: 'briefly', points: 5 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q13b', text: 'Eu fico com fome logo depois de comer 🍽️', value: 'hungry_soon', points: 2 },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q14b', text: 'Eu vivo altos e baixos constantes 🎢', value: 'ups_downs', points: 2 },
      { id: 'q14c', text: 'Eu vivo cansada, mesmo dormindo bem 😴', value: 'always_tired', points: 1 },
      { id: 'q14d', text: 'Eu me sinto bem e estável 😐', value: 'stable', points: 8 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q15a', text: 'Eu sinto que perdi anos indo pelo caminho mais difícil 😞', value: 'wasted_years', points: 2 },
      { id: 'q15b', text: 'Eu sinto que finalmente encontrei a causa real 🤓', value: 'found_cause', points: 3 },
      { id: 'q15c', text: 'Eu preciso disso pra ontem 🏃‍♂️', value: 'need_now', points: 1 },
      { id: 'q15d', text: 'Eu acho que é hora de testar antes de julgar 🚀', value: 'test_first', points: 6 },
    ],
  ...
  // PERGUNTA DE PESO ATUAL E DESEJADO
  {
    ...
    type: 'single',
    options: [
      { id: 'weight_60_55', text: 'Peso atual: 60-70kg | Peso ideal: 55-60kg 🎯', value: 'light_loss', points: 6 },
      { id: 'weight_70_60', text: 'Peso atual: 70-80kg | Peso ideal: 60-65kg 🎯', value: 'moderate_loss', points: 4 },
      { id: 'weight_80_65', text: 'Peso atual: 80-90kg | Peso ideal: 65-70kg 🎯', value: 'significant_loss', points: 2 },
  ...
  // ETAPA 5/6: A Inflamação Invisível Que Está Silenciando Seu Corpo 🔥
  {
    ...
    type: 'single',
    options: [
      { id: 'q16a', text: 'Eu sinto uma sensação de alívio — finalmente faz sentido 😌', value: 'relief', points: 3 },
      { id: 'q16b', text: 'Eu sinto raiva — porque ninguém nunca me explicou isso 😣', value: 'anger', points: 2 },
      { id: 'q16c', text: 'Eu sinto urgência — preciso reverter isso agora 🏃‍♀️', value: 'urgency', points: 1 },
      { id: 'q16d', text: 'Eu tive um estalo — é isso que estava ignorando 💡', value: 'realization', points: 2 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q17b', text: 'Eu me vejo presa no mesmo corpo, com os mesmos medos 😞', value: 'trapped', points: 2 },
      { id: 'q17c', text: 'Eu me vejo esperando que algo mude sem mudar nada 🙏', value: 'waiting', points: 4 },
      { id: 'q17d', text: 'Eu me vejo tentando fingir que não me importo mais 😐', value: 'pretending', points: 6 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q18b', text: 'Alta — eu preciso entender e aplicar agora 🏃‍♂️', value: 'high', points: 2 },
      { id: 'q18c', text: 'Média — eu quero ver se isso funciona pra mim 🤔', value: 'medium', points: 5 },
      { id: 'q18d', text: 'Baixa — eu ainda me falta clareza 😶', value: 'low', points: 8 },
    ],
  ...
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q19a', text: 'Eu sinto que o sistema escondeu isso de mim 😤', value: 'hidden', points: 2 },
      { id: 'q19b', text: 'Eu sinto que finalmente encontrei a saída verdadeira 🚪', value: 'found_exit', points: 1 },
      { id: 'q19c', text: 'Eu sempre soube que o natural vence no longo prazo 🌿', value: 'natural_wins', points: 3 },
      { id: 'q19d', text: 'Eu sinto que é minha chance de assumir o controle 🎉', value: 'take_control', points: 2 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'event_nenhum', text: 'Nenhum evento específico', value: 'nenhum', points: 8 },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'q20b', text: 'Sim, eu quero entender como aplicar isso 📝', value: 'want_to_learn', points: 3 },
      { id: 'q20c', text: 'Sim, eu cansei de viver no corpo errado 😩', value: 'tired_wrong_body', points: 1 },
      { id: 'q20d', text: 'Eu ainda não estou, mas estou perto 😐', value: 'almost', points: 6 },
    ],
  ...
  // ETAPA 6/6: OFERTA DO PROTOCOLO 🌿
  {
    ...
    type: 'single',
    options: [
      { id: 'q21a', text: 'Plano Básico - R$29,90/mês (protocolo dos 3 chás) 🧪', value: 'basic', points: 6 },
      { id: 'q21b', text: 'Plano Completo - R$39,90/mês (protocolo + 4 bônus) 💪', value: 'complete', points: 3 },
      { id: 'q21c', text: 'Plano Vitalício - R$97 único (tudo dos outros planos + acompanhamento por 1 mês) 🌟', value: 'lifetime', points: 1 },
      { id: 'q21d', text: 'Ainda não tenho certeza 🤔', value: 'unsure', points: 8 },
    ],
    microFeedback: ''
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q22a', text: 'Jejum Metabólico Coreano (emagrecer sem sofrimento) 🇰🇷', value: 'korean_fasting', points: 4 },
      { id: 'q22b', text: 'Vício em Doces Nunca Mais (parar compulsão) 🍬', value: 'sugar_addiction', points: 1 },
      { id: 'q22c', text: 'Receita da Vovó (limpar intestino) 👵', value: 'grandma_recipe', points: 2 },
      { id: 'q22d', text: 'Acelerador Metabólico Subconsciente 🧠', value: 'subconscious', points: 5 },
    ],
    microFeedback: ''
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q23a', text: 'Sim, posso testar sem risco 🚀', value: 'no_risk', points: 1 },
      { id: 'q23b', text: 'Sim, isso me dá segurança total 🔒', value: 'security', points: 3 },
      { id: 'q23c', text: 'Sim, posso sair do modo "esperar e torcer" ⏳', value: 'stop_waiting', points: 1 },
      { id: 'q23d', text: 'Ainda tenho dúvidas 😐', value: 'still_doubts', points: 6 },
    ],
    microFeedback: ''
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q24a', text: 'SIM! Estou 100% pronta para mudar 💪', value: 'ready_100', points: 1 },
      { id: 'q24b', text: 'SIM! Cansei de viver no corpo errado 😤', value: 'tired_wrong_body', points: 1 },
      { id: 'q24c', text: 'SIM! Quero o protocolo agora 🏃‍♀️', value: 'want_now', points: 1 },
      { id: 'q24d', text: 'Ainda não estou decidida 😐', value: 'not_decided', points: 8 },
    ],
    microFeedback: ''
  },
  {
    ...
    type: 'single',
    options: [
      { id: 'q25a', text: 'BÁSICO - R$29,90/mês (protocolo dos 3 chás) 💳', value: 'basic', points: 6 },
      { id: 'q25b', text: 'COMPLETO - R$39,90/mês (protocolo + 4 bônus) 💪', value: 'complete', points: 3 },
      { id: 'q25c', text: 'VITALÍCIO - R$97 único (tudo dos outros planos + acompanhamento por 1 mês) 🌟', value: 'lifetime', points: 1 },
      { id: 'q25d', text: 'Não quero agora 😐', value: 'not_now', points: 8 },
    ],
    microFeedback: ''
  },
];
